...
switch (_var) do
{
	...
	case "life_inv_kidney": {(localize "STR_Item_BlackMarketKidney")};
	case "life_inv_scalpel": {"Scalpel"};
	case "life_inv_lung": {(localize "STR_Item_BlackMarketLung")};
	case "life_inv_spleen": {(localize "STR_Item_BlackMarketSpleen")};
	...
	case "license_cop_bounty": {"Bounty Hunter"};
