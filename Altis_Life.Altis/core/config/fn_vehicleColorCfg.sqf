...
switch (_vehicle) do
{
	...
	case "C_Hatchback_01_sport_F":
	{
		...
		[
			...
			["textures\HighwaySportscar.jpg","cop"]
		];
	};
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\PoliceSuv.jpg","cop"],
			["textures\SUV_dea_1.jpg","cop"],
			["textures\MedicSuv.jpg","med"]
		];
	};
