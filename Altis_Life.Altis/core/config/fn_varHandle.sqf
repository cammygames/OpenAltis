...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "leg": {"life_inv_leg"};
			case "eyes": {"life_inv_eyes"};
			case "testicles": {"life_inv_testicles"};
			case "bodypart": {"life_inv_bodypart"};
			case "kidney": {"life_inv_kidney"};
			case "scalpel": {"life_inv_scalpel"}; 
			case "lung": {"life_inv_lung"};
			case "spleen": {"life_inv_spleen"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_lung": {"lung"};
			case "life_inv_spleen": {"spleen"};			
			case "life_inv_leg": {"leg"};
			case "life_inv_eyes": {"eyes"};
			case "life_inv_testicles": {"testicles"};
			case "life_inv_bodypart": {"bodypart"}; 
